...
- **Zip — Valid** — get, enable, and disable a valid zip feature.
- **Zip — Unavailable** — attempt to enable an unavailable zip feature (expects HTTP 400).
- **Edge Cases — Nonexistent Feature** — enable or get a feature slug that does not exist.

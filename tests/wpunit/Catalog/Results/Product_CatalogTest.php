...
final class Product_CatalogTest extends UplinkTestCase {
	...
	public function test_has_access_returns_true_when_tier_meets_minimum(): void {
		$catalog = Product_Catalog::from_array( [
			'product_slug' => 'test',
			'tiers'        => [
				[ 'slug' => 'basic', 'name' => 'Basic', 'rank' => 1, 'purchase_url' => '' ],
			...
			'features'     => [
				[
					'feature_slug' => 'security',
					'type'         => 'plugin',
					'minimum_tier' => 'pro',
					'plugin_file'  => 'security/security.php',
					'is_dot_org'   => false,
					'download_url' => 'https://example.com/security',
					'name'         => 'Security',
		...
		$this->assertTrue( $catalog->has_access( 'security', 'pro' ) );
		$this->assertTrue( $catalog->has_access( 'security', 'agency' ) );
	}

	public function test_has_access_returns_false_when_tier_below_minimum(): void {
		$catalog = Product_Catalog::from_array( [
			'product_slug' => 'test',
			'tiers'        => [
				[ 'slug' => 'basic', 'name' => 'Basic', 'rank' => 1, 'purchase_url' => '' ],
		...
		$this->assertFalse( $catalog->has_access( 'security', 'basic' ) );
	}

	public function test_has_access_returns_false_for_unknown_feature(): void {
		$catalog = Product_Catalog::from_array( [
			'product_slug' => 'test',
			'tiers'        => [
				[ 'slug' => 'basic', 'name' => 'Basic', 'rank' => 1, 'purchase_url' => '' ],
		...
		$this->assertFalse( $catalog->has_access( 'nonexistent', 'basic' ) );
	}

	public function test_has_access_returns_false_for_unknown_tier(): void {
		$catalog = Product_Catalog::from_array( [
			'product_slug' => 'test',
			'tiers'        => [
				[ 'slug' => 'basic', 'name' => 'Basic', 'rank' => 1, 'purchase_url' => '' ],
		...
		$this->assertFalse( $catalog->has_access( 'security', 'enterprise' ) );
	}
